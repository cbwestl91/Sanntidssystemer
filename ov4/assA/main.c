...
static void LEDtoggle1(void *pvParameters);
static void LEDtoggle2(void *pvParameters);
...
int main()
{
	...
	// assignment 1
	xTaskCreate(LEDtoggle1, (signed char *) "lol", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
	xTaskCreate(LEDtoggle2, (signed char *) "wtf", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
